	...
	<div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
		<div class="md:flex md:justify-between">
			<div class="mb-6 md:mb-0">
				<a href="https://flowbite.com/" class="flex items-center">
					<img src="/logo.png" class="h-8 me-3" />
			...
			<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
				<div>
					<h2 class="mb-6 text-sm font-semibold uppercase text-white">Train</h2>
					<ul class="text-gray-300 font-medium">
						<li class="mb-4">
							<a href="/questionbank/rw" class="hover:underline">Reading</a>
						</li>
						<li>
							<a href="/questionbank/math" class="hover:underline">Math</a>
						</li>
					</ul>
				</div>
				<div>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
			<span class="text-sm text-white sm:text-center dark:text-gray-400"
				>© 2024 <a href="https://flowbite.com/" class="hover:underline">Sigma SAT</a>. All Rights
				Reserved.
			</span>
			<div class="flex mt-4 sm:justify-center sm:mt-0">
				<a
					href="https://discord.gg/77fHugCbd8"
